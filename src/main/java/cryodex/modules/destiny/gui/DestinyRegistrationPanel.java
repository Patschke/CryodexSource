...
public class DestinyRegistrationPanel implements RegistrationPanel {
	...
	public JPanel getPanel() {
		if (panel == null) {
			...
			panel.add(new JLabel("<html><b>Destiny</b></html>"), gbc);
