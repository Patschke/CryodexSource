...
public class DestinyRankingTable extends RankingTable {
	...
	public DestinyRankingTable(Tournament tournament) {
		super(new BorderLayout());
		JScrollPane scrollPane = new JScrollPane(getTable());
		ComponentUtils.forceSize(this, 400, 300);
		this.tournament = (DestinyTournament) tournament;
...
//	        c.setForeground(Color.black);
	...
	private class RankingTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int arg0, int arg1) {
			DestinyPlayer user = (DestinyPlayer) data.get(arg0).getModuleInfoByModule(tournament.getModule());
			Object value = null;
			switch (arg1) {
			case 0:
