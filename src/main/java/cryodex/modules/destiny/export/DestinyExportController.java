...
public class DestinyExportController extends ExportController {
    ...
    public String getMatchStats(Match match, Tournament tournament) {
        ...
        DestinyPlayer xp1 = (DestinyPlayer) tournament.getModulePlayer(match.getPlayer1());
        DestinyPlayer xp2 = (DestinyPlayer) tournament.getModulePlayer(match.getPlayer2());
