...
public class ArmadaRankingTable extends RankingTable {
	...
	public ArmadaRankingTable(Tournament tournament) {
		super(new BorderLayout());
		JScrollPane scrollPane = new JScrollPane(getTable());
		ComponentUtils.forceSize(this, 400, 300);
		this.tournament = (ArmadaTournament) tournament;
...
//	        c.setForeground(Color.black);
	...
	private class RankingTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int arg0, int arg1) {
			ArmadaPlayer user = (ArmadaPlayer) data.get(arg0).getModuleInfoByModule(tournament.getModule());
			Object value = null;
			switch (arg1) {
			case 0:
