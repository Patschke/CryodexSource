package cryodex.modules.runewars.wizard;
...
public class ProgressionCutPage implements Page {
    ...
    public void onNext() {
        ...
        RunewarsTournament mergedTournament = (RunewarsTournament) WizardUtils.getMergedTournament(wizardOptions);

        List<Player> playersToAdd = new ArrayList<Player>();

        for (Player p : rankedPlayers) {
        	
        	RunewarsPlayer xp = mergedTournament.getRunewarsPlayer(p);
