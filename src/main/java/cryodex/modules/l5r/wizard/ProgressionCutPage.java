...
public class ProgressionCutPage implements Page {
    ...
    private final Map<L5RTournament, JCheckBox> checkBoxMap = new HashMap<L5RTournament, JCheckBox>();
    ...
    public JPanel getPanel() {
        ...
        if (pagePanel == null) {
            ...
            for (Tournament t : CryodexController.getAllTournaments()) {
                ...
                if (t instanceof L5RTournament) {
                    checkBoxMap.put((L5RTournament) t, cb);
                }
    ...
    public void onNext() {
        ...
        for (L5RTournament t : checkBoxMap.keySet()) {
        ...
        L5RTournament mergedTournament = (L5RTournament) WizardUtils.getMergedTournament(wizardOptions);

        List<Player> playersToAdd = new ArrayList<Player>();

        for (Player p : rankedPlayers) {
        	
        	L5RPlayer xp = mergedTournament.getModulePlayer(p);
