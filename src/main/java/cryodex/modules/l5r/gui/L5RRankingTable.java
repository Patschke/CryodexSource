...
public class L5RRankingTable extends RankingTable {
	...
	public L5RRankingTable(Tournament tournament) {
		super(new BorderLayout());
		JScrollPane scrollPane = new JScrollPane(getTable());
		ComponentUtils.forceSize(this, 400, 300);
		this.tournament = (L5RTournament) tournament;
	...
	public void setPlayers(Set<Player> players) {
		...
		Collections.sort(playerList, new L5RComparator(tournament,
				L5RComparator.rankingCompare));
...
//	        c.setForeground(Color.black);
	...
	private class RankingTableModel extends AbstractTableModel {
		...
		public void resetData() {
			Collections.sort(data, new L5RComparator(tournament,
					L5RComparator.rankingCompare));
		...
		public Object getValueAt(int arg0, int arg1) {
			L5RPlayer user = (L5RPlayer) data.get(arg0).getModuleInfoByModule(tournament.getModule());
			Object value = null;
			switch (arg1) {
			case 0:
