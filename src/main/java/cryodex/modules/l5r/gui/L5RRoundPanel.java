    ...
    private class GamePanel extends RoundPanel.GamePanel {
        ...
        private String[] getComboValues() {
            ...
            if (getMatch().getPlayer2() == null) {
                ...
                String[] values = { generic, "WIN - " + getMatch().getPlayer1().getName(), "WIN - " + getMatch().getPlayer2().getName(),
                        "MOD WIN - " + getMatch().getPlayer1().getName(), "MOD WIN - " + getMatch().getPlayer2().getName() };
                return values;
            }
        }
        ...
        public void setMatchResultFromGUI() {
            ...
            case 2:
                ...
                break;
            case 3:
                getMatch().setGame1Result(GameResult.PLAYER_1_MOD_WINS);
                break;
            case 4:
                getMatch().setGame1Result(GameResult.PLAYER_2_MOD_WINS);
                break;
            default:
                break;
            }
        ...
        public void setGUIFromMatch() {
            ...
            if (getTournament().isMatchComplete(getMatch())) {
                if (getMatch().isBye()) {
                    ...
                    } else if (getMatch().getGame1Result() == GameResult.PLAYER_1_MOD_WINS) {
                        getResultCombo().setSelectedIndex(3);
                    } else if (getMatch().getGame1Result() == GameResult.PLAYER_2_MOD_WINS) {
