...
public class KraytComparator extends TournamentComparator<Player> {
	...
	public KraytComparator(Tournament t, CompareOptions[] sortOrder) {
		this.t = t;
	...
	private int compareOption(Player p1, Player p2,
		...
		KraytPlayer o1 = (KraytPlayer) t.getModulePlayer(p1);
		KraytPlayer o2 = (KraytPlayer) t.getModulePlayer(p2);
