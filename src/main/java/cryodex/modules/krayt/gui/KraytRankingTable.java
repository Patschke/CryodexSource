...
public class KraytRankingTable extends RankingTable {

    private static final long serialVersionUID = 5587297504827909147L;

    public KraytRankingTable(Tournament tournament) {
        super(tournament);
    }
    ...
    private class RankingTableModel extends BaseRankingTableModel {
        ...
        public Object getValueAt(int arg0, int arg1) {
            KraytPlayer user = (KraytPlayer) getTournament().getModulePlayer(getData().get(arg0));
            Object value = null;
            switch (arg1) {
            case 0:
