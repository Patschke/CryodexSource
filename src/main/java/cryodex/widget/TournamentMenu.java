...
public class TournamentMenu implements Menu {
				...
				public void actionPerformed(ActionEvent e) {
					if(CryodexController.getActiveTournament() == null){
						JOptionPane.showMessageDialog(Main.getInstance(),
								"There are no tournaments to do this action.");
						return;
					}
		...
		if (playersMenu == null) {
			...
			addPlayer.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (players.isEmpty()) {
						...
						PlayerSelectionDialog d = new PlayerSelectionDialog(players) {
			...
			dropPlayer.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					JDialog d = new PlayerSelectionDialog(CryodexController.getActiveTournament().getPlayers()) {
		...
		if (exportMenu == null) {
			...
			exportMatchSlipsWithStats.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					tournament.getExportController().exportTournamentSlipsWithStats(tournament, round.getMatches(),
							roundNumber);
				}
			});
			...
			saveJSON.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (t == null || t instanceof XWingTournament == false) {
						JOptionPane.showMessageDialog(Main.getInstance(),
								"No X-Wing tournament available for this operation");
						return;
					}
	...
	private abstract class PlayerSelectionDialog extends JDialog {
		...
		public PlayerSelectionDialog(List<Player> players) {
		...
		public abstract void playerSelected(Player p);
	}
	...
	private class CutPlayersDialog extends JDialog {
		...
		public CutPlayersDialog() {
			...
			mainPanel.add(ComponentUtils.addToHorizontalBorderLayout(new JLabel("Cut to top: "), cutCombo, null),
					BorderLayout.CENTER);
